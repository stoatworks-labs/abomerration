/**
    ...
    `CFFGLPluginInfo` that Abomerration.cpp registers at static-initialisation
    ...
    which build it is.
        ...
        strings Abomerration.bundle/Contents/MacOS/Abomerration | grep abomerration
*/

extern "C" const char* AbomerrationBuildStamp()
{
	return "abomerration " ABOMERRATION_VERSION " built " __DATE__ " " __TIME__;
}
