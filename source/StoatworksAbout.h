/*
 * Stoatworks Labs - About window data for Abomerration.
 *
...
{
    inline constexpr auto name = "Abomerration";
    inline constexpr auto slug = "abomerration";
    inline constexpr auto hook = "Sound-reactive chromatic aberration for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/abomerration/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/abomerration/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/abomerration";
